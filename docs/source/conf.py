# -*- coding: utf-8 -*-
#
# aws_code_artifact_python_example documentation build configuration file, created by
...
import aws_code_artifact_python_example as package
...
# Add data for Jinja2
try:
    from aws_code_artifact_python_example.docs import doc_data
except:
    doc_data = dict()
