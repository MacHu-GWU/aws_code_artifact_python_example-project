...
repo_name = "aws_code_artifact_python_example-project"
github_token_name = "sanhe-dev"
aws_profile = "bmt_app_devops_us_east_1"
aws_codeartifact_domain = "bmt"  # make sure it match pyproject.toml
aws_codeartifact_repository = "bmt-python"  # make sure it match pyproject.toml
